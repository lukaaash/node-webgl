...
var _texImage2D_pivot24 = gl.texImage2D_pivot24;
gl.texImage2D_pivot24 = function texImage2D_pivot24(target, level, internalformat, width, height, border, format, type, pixels) {
  if(!(arguments.length == 9 || arguments.length == 6)) {
    throw new TypeError('Expected texImage2D_pivot24(number target, number level, number internalformat, number width, number height, number border, number format, number type, ArrayBufferView pixels) \
        or texImage2D_pivot24(number target, number level, number internalformat, number format, number type, Image pixels)');
  }
  ...
  if (arguments.length == 6) {
    ...
    if(!(
        ...
        typeof width === "number" && typeof height === "number" && 
        (border==null || border instanceof Image))) {
      throw new TypeError('Expected texImage2D_pivot24(number target, number level, number internalformat, number format, number type, Image pixels)');
    }
    pixels=border;
    type=height;
    format=width;
    return _texImage2D_pivot24(target, level, internalformat, pixels.width, pixels.height, 0, format, type, pixels);
  }
  else if (arguments.length == 9) {
    if(!(typeof target === "number" && 
        typeof level === "number" && typeof internalformat === "number" && 
    ...
    return _texImage2D_pivot24(target, level, internalformat, width, height, border, format, type, pixels);
  }
}
...
var _texSubImage2D_pivot24 = gl.texSubImage2D_pivot24;
gl.texSubImage2D_pivto24 = function texSubImage2D_pivot24(target, level, xoffset, yoffset, width, height, format, type, pixels) {
  if (!(arguments.length === 9 && typeof target === "number" && typeof level === "number" && 
      typeof xoffset === "number" && typeof yoffset === "number" && 
      typeof width === "number" && typeof height === "number" && 
      typeof format === "number" && typeof type === "number" && 
      (pixels==null || typeof pixels === "object"))) {
    throw new TypeError('Expected texSubImage2D_pivot24(number target, number level, number xoffset, number yoffset, number width, number height, number format, number type, ArrayBufferView pixels)');
  }
  return _texSubImage2D_pivot24(target, level, xoffset, yoffset, width, height, format, type, pixels);
}
